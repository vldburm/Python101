...
def my_sum ():
    ...
    ex = False
    while ex == False:
        number = input('Введите числа разделенные пробелом или Q для завершения - ').split()
        res = 0
    ...
    print(f'Вы завершили использование программы. Итоговая сумма составила: {sum_res}')
my_sum()